...
- **D-04:** A IA (wire AI SDK + Gemini 2.5 Flash-Lite via AI Gateway no seam `suggestCategory()` já pronto + `validateSuggestion` enum wrapper) é **diferida para o próximo milestone (v1.4)** — ver Deferred.
