...
| confirm | 1 | KW-05 | nothing persists till confirm; confirm learns merchant→category as today (no special-case) | integration | `npx vitest run src/actions/import.test.ts` (confirm learn) | ✅ extend | ⬜ pending |
