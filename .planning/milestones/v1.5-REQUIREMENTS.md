# Requirements Archive: v1.5 Classificação determinística
...
- [x] **MKT-01**: A categoria default "Marketplace" (migration `0035`) está aplicada em PROD (`supabase db push`) e presente na conta — dando à IA e às regras um bucket de compras de marketplace. _(Live human-verify fechado 2026-06-20 — 18-UAT.md 3/3 pass.)_
