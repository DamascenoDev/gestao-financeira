...
- [ ] **RSV-01**: Usuário cria reserva nomeada (ex: Apê, Carro) com valor-alvo opcional
...
- [ ] **RSV-04**: Usuário registra saída (retirada) de uma reserva, com histórico de entradas/saídas por reserva
- [ ] **RSV-05**: Saldo da reserva é sempre derivado (entradas − saídas) e mostra barra de progresso vs alvo quando houver
