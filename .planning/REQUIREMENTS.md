...
| CAR-05 | Phase 11 | Complete (detalhe /carros/[id]: 3 KPI cards [km/l médio, R$/km, gasto total de v_carro_resumo] + gasto-por-categoria bars [agregação inline RLS-scoped, soma bigint por category_id point-in-time, D4 não-destrutivo] + CarroConsumoChart [linha km/l token-aware --chart-1, tooltip pt-BR, null/0-drop] + histórico Phase-10 integrado; lista /carros com gasto+km/l por card '—' sem-dados. SEC-01 re-auditado exit 0. Suíte 735, tsc/build limpos, human-verify aprovado light+dark+mobile. Review: 0 blocker, 4 warnings corrigidos) |
